...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str,
                        default="./ID_generation/preprocessing/processed/Beauty_embeddings.npy",
    ...
    parser.add_argument("--ckpt_dir", type=str, default="./results", help="output directory for model")
