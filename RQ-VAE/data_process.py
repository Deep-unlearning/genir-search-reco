...
def meta_map(meta_infos, data_maps):
    id2meta={}
    item2meta={}
...
def preprocessing(dataset_name, data_type='Amazon', require_attributes = False):
    data_file =  f"./ID_generation/preprocessing/processed/{dataset_name}.txt"
    id2meta_file = f"./ID_generation/preprocessing/processed/{dataset_name}_id2meta.json"
    ...
    interaction_file = f"./ID_generation/preprocessing/processed/{dataset_name}.inter.json"
    ...
    if data_type=='yelp':
        ...
        datas = Amazon('./ID_generation/preprocessing/raw_data/reviews_'+dataset_name + '_5.json.gz', rating_score=rating_score)
    ...
    if data_type == 'Amazon':
        ...
        data_maps, id2meta=meta_map(meta_infos, data_maps)
    else:
    ...
    with open(interaction_file, 'w') as out:
        # save user_items_id
        json.dump(user_items_id, out)    
